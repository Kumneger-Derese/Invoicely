  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <form
        ...
        className="flex flex-col gap-y-4 w-full px-4 md:w-3/6 mx-auto"
      >
        {/* Title Field */}
        <div className="flex flex-col w-full gap-1">
          <label htmlFor="title" className="text-neutral-300 font-semibold">
            Product Title
          </label>
          <input
            type="text"
        ...
        {/* Price Field */}
        <div className="flex flex-col w-full gap-1">
          <label htmlFor="price" className="text-neutral-300 font-semibold">
            Product Price
          </label>
          <input
            type="number"
        ...
        <button className="bg-lime-400 text-neutral-900 font-bold rounded-md p-2 hover:bg-lime-600 hover:text-lime-200 transition duration-300">
          Update Product
        </button>
      </form>
    </div>
