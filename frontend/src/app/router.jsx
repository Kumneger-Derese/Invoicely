...
import Settings from "../page/Dashboard/Settings.jsx";
import ErrorPage from "../page/ErrorPage.jsx";
import InvoicePdfPreviewPage from "../page/InvoicePdfPreviewPage.jsx";
  ...
  createRoutesFromElements(
    <Route path="/" element={<App />} errorElement={<ErrorPage />}>
      ...
      <Route path="" element={<ProtectedRoute />}>
        ...
        <Route path="pdf/:invoiceId" element={<InvoicePdfPreviewPage />} />
