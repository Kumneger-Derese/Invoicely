...
const readNotification = asyncHandler(async (req, res, next) => {
    ...
    if (!notification) return next(new ApiError('Notification to read not found', 404))
...
const deleteNotification = asyncHandler(async (req, res, next) => {
    ...
    if (!notification) return next(new ApiError('Notification to delete not found.', 404))
...
export {getNotifications, deleteNotifications, deleteNotification, readNotification, readNotifications}